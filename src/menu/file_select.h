...
#define MENU_RANDOM_HOVER_0 0
#define MENU_RANDOM_HOVER_1 1
#define MENU_RANDOM_HOVER_2 2
#define MENU_RANDOM_HOVER_3 3
#define MENU_RANDOM_HOVER_4 4
#define MENU_RANDOM_HOVER_5 5
#define MENU_RANDOM_HOVER_6 6
#define MENU_RANDOM_HOVER_7 7
#define MENU_RANDOM_HOVER_8 8
#define MENU_RANDOM_HOVER_9 9
#define MENU_RANDOM_HOVER_10 10
#define MENU_RANDOM_HOVER_11 11
#define MENU_RANDOM_HOVER_12 12
#define MENU_RANDOM_HOVER_13 13
#define MENU_RANDOM_HOVER_14 14
#define MENU_RANDOM_HOVER_15 15
#define MENU_RANDOM_HOVER_NONE 16
...
enum MenuButtonTypes {
    ...
    // Random Mode Menu (SEED SETUP)
    MENU_BUTTON_RANDOM_FILE_B = MENU_BUTTON_OPTION_MAX,
    MENU_BUTTON_RANDOM_MIN,
    MENU_BUTTON_RANDOM_ACCEPT = MENU_BUTTON_RANDOM_MIN,
    MENU_BUTTON_RANDOM_CLEAR,
    MENU_BUTTON_RANDOM_MAX
};
